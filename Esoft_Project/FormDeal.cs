...
namespace Esoft_Project
{
    public partial class FormDeal : Form
    {
        ...
        void ShowSupply()
        {
            ...
            foreach (SupplySet supplySet in Program.агенство_Недвижимости.SupplySet)
            {
                string[] item = { supplySet.Id.ToString() + ". ", "" + supplySet.AgentSet.LastName, "" + supplySet.ClientsSet.LastName };
        ...
        void ShowDemand()
        {
            ...
            foreach (DemandSet demandSet in Program.агенство_Недвижимости.DemandSet)
            {
                string[] item = { demandSet.Id.ToString() + ". ", "" + demandSet.AgentSet.LastName, "" + demandSet.ClientsSet.LastName };
        ...
        void Deductions()
        {
            ...
            {
                SupplySet supplySet = Program.агенство_Недвижимости.SupplySet.Find(Convert.ToInt32(comboBoxSupply.SelectedItem.ToString().Split('.')[0]));
                DemandSet demandSet = Program.агенство_Недвижимости.DemandSet.Find(Convert.ToInt32(comboBoxDemand.SelectedItem.ToString().Split('.')[0]));
                double customerCompanyDeductions = supplySet.Price * 0.3;
            ...
            if (comboBoxSupply.SelectedItem != null)
            {
                ...
                {
                    sellerCompanyDeductions = 30000 + supplySet.Price * 0.2;
                    textBoxAgentSellerDeductions.Text = sellerCompanyDeductions.ToString("0.00");
                }
                else
                {
        ...
        void ShowDealSet()
        {
            ...
            foreach (DealSet deal in Program.агенство_Недвижимости.DealSet)
            {
                ...
                "r. " + deal.SupplySet.RealEstateSet.Address_City + ", ul. " + deal.SupplySet.RealEstateSet.Address_Street + ", d. " +
                deal.SupplySet.RealEstateSet.Address_House + ", kv. " + deal.SupplySet.RealEstateSet.Address_Number,
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DealSet deal = listViewDealSet.SelectedItems[0].Tag as DealSet;
                    Program.агенство_Недвижимости.DealSet.Remove(deal);
                    Program.агенство_Недвижимости.SaveChanges();
                    ShowDealSet();
                }
                comboBoxSupply.SelectedItem = null;
